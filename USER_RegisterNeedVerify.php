          ...
          <div class="row">
            <div class="col-lg-4 d-none d-lg-block"><img class="img-responsive" src="ulan.jpg" width="400" height="800"></img></div>
               <div class="col-lg-8">
				...
				<div class="ms-3" style="border: 3px solid green; padding: 5px;">
  <p style="text-transform: uppercase; color: #4CAF50;">  <i class="bi bi-check-circle-fill" style="color:green;"></i>You're almost ready to get started. your registration will be approved and please check your email address verify your account!</p>
</div>
