				...
				<div class="container my-5">
					...
					<div class="table-responsive">
							...
							<?php
									...
									{
										echo "<tr><td>".  $row2["lastname"]."</td><td>". $row2["food"]."</td><td>".$row2["beverage"]."</td><td>". $row2["clothing"]."</td><td>". $row2["blanket"]."</td><td>". $row2["pillows"]."</td><td>". $row2["toilet"]."</td><td>". $row2["firstaid"]."</td><td>". $row2["medicine"]."</td><td>". $row2["medicineqty"]."</td><td>".$row2["vitamins"]."</td><td>".$row2["vitaminsqty"]."</td><td>".$row2["additional"]."</td><td>"."<a href=\"approverelief.php?relkey=" .$row2['reliefkey']. "\">Approve</a>"."</td><td>"."<a href=\"deleterelief.php?relkey=" .$row2['reliefkey']. "\">Cancel</a>"."</td></tr>";
									}
										echo "</tbody>";
									}
										else {
