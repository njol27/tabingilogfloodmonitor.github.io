...
$additional=$_POST['additional'];
		...
		$sql = "INSERT INTO `relief` (`food`, `beverage`, `clothing`, `blanket`, `pillows`, `toilet`,`firstaid`,`medicine`,`medicineqty`,`vitamins`,`vitaminsqty`, `additional`, `reliefkey`) VALUES ('$food','$beverage', '$clothing', '$blanket', '$pillows', '$toilet', '$firstaid', '$medicine', '$medicineqty', '$vitamins', '$vitaminsqty', '$additional', (SELECT id FROM info WHERE email = '".$_SESSION['email']."' AND password = '".$_SESSION['password']."'))";
				...
				<form class="container user" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
								...
								<div class="form-group row m-3">
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
										...
										<input type="submit" value="Request" name="request" class="btn btn-dark btn-user me-2">
										
										
										<input type="submit" value="Update" name="update" class="btn btn-light btn-user me-2" disabled>
                                    </div>
