...
$sql = "INSERT INTO `feedback` (`fdback`,`star5`,`star4`,`star3`, `star2`, `star1`, `fbkey`) VALUES ('$fback', '$star5','$star4', '$star3', '$star2', '$star1', (SELECT id FROM info WHERE email = '".$_SESSION['email']."' AND password = '".$_SESSION['password']."'))";

 if(mysqli_query($con, $sql)) {
	
		header ("Location: USER_Feedback.php");
			$_SESSION['prompt'] = "Feedback Submitted";
			  unset($_SESSION['errprompt']);
	} else {

	      $_SESSION['errprompt'] = "Failed";
	...
	<!--feedback and rating-->
             ...
             <div class="col-9 p-3"  style="background-color:#f6f9fe">
				<form class="container user" >
							<div class="text-center">
                                <h1 class="h4 text-gray-900 m-3">Feedback and Reviews</h1>
                            </div>
                               
	 <div class="w-25 bi bi-star-fill text-warning" style="height: 10%"></div>
	 ...
	 <table>
									...
									while ($row = $post -> fetch_assoc())
										...
										{							
										echo "<tr><td>". $row["fdback"]."</td><td>"."_"."</td><td>". $row["star5"]."</td><br></tr>";
								...
								<div class="form-group row m-3">
									...
									Feedback:
										<textarea type="text" class="form-control form-control-user" id="TextArea"
                                            placeholder="Input Here..." name="feedback"></textarea>
									</div>
								</div>
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
										<input type="submit" value="Submit" name="register" class="btn btn-dark btn-user me-2">
