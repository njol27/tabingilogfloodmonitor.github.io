...
<div class="chat-popup" id="myForm">
 ...
 <div class="offcanvas-header">
    ...
    <button id="insrt" class="btn">Send</input>
...
function myFunction() {
  ...
  if(t.value >=4){
	...
	document.getElementById("level2").addEventListener("change", myFunctionTwo);
function myFunctionTwo() {
  var t2 = document.getElementById("level2");
  var b2 = document.getElementById("evacBut2");
  if(t2.value >=4){
      b2.value = "Evacuate";
	  b2.className = "btn btn-danger btn-icon-split ms-5";
	  b2.innerHTML = "Evacuate";
	  }
  else if(t2.value >=3){
	        b2.value = "Warning";
	  b2.className = "btn btn-secondary btn-icon-split ms-5";
	  b2.innerHTML = "Warning";
	  }
	   else {
	  	        b2.value = "Alert";
	  b2.className = "btn btn-warning btn-icon-split ms-5";
	  b2.innerHTML = "Alert";
	  }
}


	document.getElementById("level3").addEventListener("change", myFunctionThree);
function myFunctionThree() {
  var t3 = document.getElementById("level3");
  var b3 = document.getElementById("evacBut3");
  if(t3.value >=4){
      b3.value = "Evacuate";
	  b3.className = "btn btn-danger btn-icon-split ms-5";
	  b3.innerHTML = "Evacuate";
	  }
  else if(t3.value >=3){
	        b3.value = "Warning";
	  b3.className = "btn btn-secondary btn-icon-split ms-5";
	  b3.innerHTML = "Warning";
	  }
	   else {
	  	        b3.value = "Alert";
	  b3.className = "btn btn-warning btn-icon-split ms-5";
	  b3.innerHTML = "Alert";
	  }
}
</script>
